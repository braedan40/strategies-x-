...
OldNamecall = hookmetamethod(game, '__namecall', function(...)
    ...
    if getnamecallmethod() == 'HttpGet' then
        if table.find(LinkTable, Args[1]) then
            Args[1] = "https://raw.githubusercontent.com/braedan40/strategies-x-/refs/heads/main/TDS/MainSource.lua"
...
OldHook = hookfunction(game.HttpGet, function(Self, Url, ...)
    ...
    if table.find(LinkTable, Url) then
        Url = "https://raw.githubusercontent.com/braedan40/strategies-x-/refs/heads/main/TDS/MainSource.lua"
